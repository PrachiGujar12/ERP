...
<div id="content">
    ...
    position: sticky;
    top: 0;
    z-index: 100;"><a href="{{url('sales-quotation')}}"
                                    class="  JewelleryPrimaryButton">
                                    <i class="bi bi-arrow-left"></i> Back
                                </a>
                            <h6 class="h3 mb-0 text-gray-800">CREATE SALES QUOTATION</h6>
                            <!--<p id="date"></p>-->
    ...
    <div class="container-fluid">
        ...
        <div class="customer__page">
            ...
            <div class="">
                <form id="customerForm" action="{{route('store.quotation')}}" method="POST">
                    @csrf
                    @if(session('success'))
