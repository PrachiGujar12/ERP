...
<div id="content">
    ...
    z-index: 100;">
        <a href="{{route('dashboard')}}" class="JewelleryPrimaryButton">
            ...
            <h1 class="h2 mb-0 text-gray-800">CATEGORY SHAPE EDIT</h1>

            <a href="{{route('categories.shape.list')}}" class="JewelleryPrimaryButton">
                <i class="fas fa-arrow-left mr-2"></i> Category shape list
            </a>
        ...
        <div class=" customer__page">
            ...
            <div class="row">
                <div class="col-12 card  p-md-4">
                    ...
                    <div>
                        <form class="form-sample" action="{{route('update.category.shape', $shape->id)}}"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 form__fields">
                                    ...
                                    <input type="text" class="form-control" name="category_name"
                                        value="{{$shape->category->category_name}}"  disabled/>
                                </div>
                                <!-- Text input -->
                                <div class="col-md-6 form__fields">
