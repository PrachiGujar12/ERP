...
<div id="content">
    ...
    top: 0;
    z-index: 100;">
        <a href="{{route('repair-items-list')}}"><button class="JewelleryPrimaryButton">
                                            ...
                                            <tbody class="text-center">
                                                @foreach($items as $item)
													...
													<td><button type="button" class="btn btn-primary m-1"  onclick="openActionAlert()">Action</button>
														<a class="btn btn-success m-1" href="{{ route('repair.order.details.show', ['order_no' => $order->id, 'itemid' => $item->repair_id]) }}">View</a></td>
