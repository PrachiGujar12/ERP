...
@section('title', 'Repair Order List')
                        ...
                        <div class="">
                            <div class="">
                                ...
                                <ul class="nav nav-pills py-3 nav-justified" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="tab-div" id="add-new-customer-tab" data-toggle="pill" href="#add-new-customer" role="tab"
    aria-controls="add-new-customer" aria-selected="false">
    <div class="card border-left-warning shadow h-100 abc">
        <div class="card-body align-content-center">
            <div class="row no-gutters align-items-center">
                ...
                <div class="col-auto">
                    <img src="{{ asset('/asset/images/icon/order.png') }}" alt="Customer Icon" class="img-fluid" width="40px">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade " id="add-new-customer" role="tabpanel"
                                ...
                                <div class="col-12 py-3 my-3 card" id="addItemsSection">
                                    ...
                                    <form id="customerForm" action="{{ route('store.newrepair.order') }}" method="POST"
                                ...
                                <div class="table-responsive">
									<div class="mb-3">
                                        <div class="text-center">
                                            ...
                                            Search: <input type="text" id="newsearchInput" class="p-1" placeholder="" onkeyup="newsearchTable()">
                                        </div>
                                    </div>
								...
								{{ ''.substr($pendingrepairOrder->customer->mobile_no, 0, 4).' '.substr($pendingrepairOrder->customer->mobile_no, 4, 3).' '.substr($pendingrepairOrder->customer->mobile_no, 7, 3).' '.substr($pendingrepairOrder->customer->mobile_no, 10) }}
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($pendingrepairOrder->order_status == 'Completed')
                                                            {{ $pendingrepairOrder->order_status }}
                                                        @else
                                                            Pending
                                                        @endif
                                                    </td>
...
@endforeach
                                                    ...
                                                    <td>
                                                                ...
                                                                <a class="btn btn-primary" title="Convert Into Invoice"
                                                                    href="{{ route('repair.items.details', ['repair_order_no' => $pendingrepairOrder->id]) }}"><button>View</button></a>
...
@endforeach
                                                    ...
                                                    <td>
														...
														<button class="btn btn-success">Invoice Completed</button>
														@else
                                                            @if ($pendingrepairOrder->order_status == 'Completed')
                                                                <a class="btn btn-primary" title="Convert Into Invoice"
                                                                    href="{{ route('repair.order.invoice', ['repair_order_no' => $pendingrepairOrder->id]) }}"><button><i
                                                        ...
                                                        <a class="btn btn-primary m-1" title="Convert Into Invoice"
                                                                    href="{{ route('repair.items.details', ['repair_order_no' => $pendingrepairOrder->id]) }}">View</a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <div class="form-row align-items-center mb-3">
            ...
            <div class="col-md-9">
                ...
                <div class="col-md-9">
                    <select class="form-control" name="form_input_karigar${rowIndex}" id="form_input_karigar${rowIndex}">
...
<script>
    function newsearchTable() {
        const input = document.getElementById("newsearchInput").value.toLowerCase();
