...
<div id="content">
    ...
    position: sticky;
    top: 0;
    z-index: 100;"><a href="{{route('ncsaleslist')}}" class="JewelleryPrimaryButton" id="backButton">
							<i class="fas fa-arrow-left mr-2"></i> Back to NC Sale
						</a>
            <div class=" mb-2 mb-md-0 p-0">
                <h6 class="h2 mb-0 text-gray-800">CREATE NC SALES</h6>
            </div>
                            <!--<p id="date"></p>-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row originalRow" id="ItemAdditionFormRow">
                                <div class="col-md-4 form__fields">
                                    <label for="textInput" class="form-label">Items</label>
        ...
        if (customerId) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "{{route('ncsaleslist')}}";
                }
            });
        }
    });
