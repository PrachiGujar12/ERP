...
<div id="content">
    ...
    top: 0;
    z-index: 100;">
        <a href="{{route('view.customer', $order->customer)}}"><button class="JewelleryPrimaryButton">
			<i class="fas fa-arrow-left mr-2"></i> Back To Customer </button>
        </a>
...
<button class="JewelleryPrimaryButton" onclick="openPrintAlert()">
    ...
    <div class="container-fluid">
        ...
        <div class="customer__page my-4">
                                            ...
                                            <tbody class="text-center">
                                                @foreach($items as $item)
													...
													<td><button type="button" class="btn btn-primary m-1"  onclick="openActionAlert()">Action</button>
														<a class="btn btn-success m-1" href="{{ route('customer.order.details', ['order_no' => $order->id, 'itemid' => $item->repair_id]) }}">View</a></td>
			...
			<div class="card my-4">
                    <div class="card-body">
                        <div class="card-header border bg-warning text-light">
...
function openselectitemAlert() {
    ...
    Swal.fire({
        title: 'Select Items',
        html: `<form id="itemsForm" action="{{ route('remove.item') }}" method="POST">@csrf ${checkboxHtml}</form>`,
        showCancelButton: true,
...
function openReturnTypeAlert() {
    Swal.fire({
        ...
        html:
            ...
            '<form id="itemsForm" action="{{ route('remove.order') }}" method="POST">@csrf <input id="amount_by_cash" name="cashamount" class="swal2-input" placeholder="Amount by Cash" type="number">' +
