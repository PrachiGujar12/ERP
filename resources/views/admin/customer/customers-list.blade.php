							...
							<div class="mb-4">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover text-center" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tr data-href="{{ route('view.customer', $customer->customer_id) }}">
                                            <td>
                                                {{ $customer->first_name }} 
                                            </td>
                                            ...
                                            <td class="mobile-number">
                                               ...
                                               {{ ''.substr($customer->mobile_no, 0, 4).' '.substr($customer->mobile_no, 4, 3).' '.substr($customer->mobile_no, 7, 3).' '.substr($customer->mobile_no, 10) }}
											...
											<td>
                                                        @if($customer->countsale == '0')
                                                        <a class="btn btn-secondary" title="View"
                                                            href="{{ route('view.customer', $customer->customer_id) }}">{{ $customer->countsale }}</a>
                                                        @else
                                            ...
                                            <td>
                                                        ...
                                                        <a class="btn btn-secondary" title="View"
                                                            href="{{ route('view.customer', $customer->customer_id) }}">{{ $customer->countncsale }}</a>
                                                        @else
                                                        <a class="btn btn-warning" title="View"
                                                            href="{{ route('view.customer', $customer->customer_id) }}">{{ $customer->countncsale }}</a>
                                                        @endif

                                                    </td>
                                                    <td>
                                                        @if($customer->countorder == '0')
                                                        <a class="btn btn-secondary" title="View"
                                                            href="{{ route('view.customer', $customer->customer_id) }}">{{ $customer->countorder }}</a>
                                                        @else
                                                        <a class="btn btn-success" title="View"
                                                            href="{{ route('view.customer', $customer->customer_id) }}">{{ $customer->countorder }}</a>
                                                        @endif
                                                    </td>
                                                    <td>@if($customer->countrepairorder == '0')
                                                        <a class="btn btn-secondary" title="View"
                                                            href="{{ route('view.customer', $customer->customer_id) }}">{{ $customer->countrepairorder }}</a>
                                                        @else
                                                    ...
                                                    <td>@if($customer->dueamount == '0')
                                                        <a class="btn btn-secondary" title="View"
                                                            href="{{ route('view.customer', $customer->customer_id) }}">£{{ number_format($customer->dueamount) }}</a>
                                                        @else
                                                        <a class="btn btn-danger" title="View"
                                                            href="{{ route('view.customer', $customer->customer_id) }}">£{{ number_format($customer->dueamount) }}</a>
