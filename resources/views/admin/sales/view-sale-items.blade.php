...
<div id="content">
    ...
    top: 0;
    z-index: 100;">
        <a href="{{route('sale.list', $salesItems->sale_id)}}"><button class="JewelleryPrimaryButton">
                            ...
                            aria-labelledby="pills-customer-tab">
							 ...
							 <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex col-12 p-0">
										...
										<p><b>Mobile Number:</b>
											{{ ''.substr($salesItems->customer->mobile_no, 0, 4).' '.substr($salesItems->customer->mobile_no, 4, 3).' '.substr($salesItems->customer->mobile_no, 7, 3).' '.substr($salesItems->customer->mobile_no, 10) }}
											</p>
