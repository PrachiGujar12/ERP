...
<div id="content">
    ...
    top: 0;
    z-index: 100;">
       <a href="{{ route('view.sales.items', $salesItems->sale_id) }}"> <button class="JewelleryPrimaryButton">
                ...
                <div class="col-12 card p-md-4 my-4">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-customer" role="tabpanel"
							...
							<form id="customerForm" action="{{ route('update.sale') }}" method="POST">
                    @csrf
							<div>
								<div>
													<input type="hidden" class="form-control" name="sale_id" value="{{$salesItems->sale_id}}" />
									
										<div class="form-row align-items-center mb-3">
												<div class="col-md-3">
													<label for="AmountPaidByCash" class="form-label">Amount Paid By Cash
												</div>
												<div class="col-md-9">
													<input type="text" class="form-control" id="AmountPaidByCash" name="AmountPaidByCash" placeholder="Enter Amount Paid By Cash" />
												</div>
											</div>
											
											<div class="form-row align-items-center mb-3">
												<div class="col-md-3">
													<label for="AmountPaidByCard" class="form-label">Amount Paid By Card
												</div>
												<div class="col-md-9">
													<input type="text" class="form-control" id="AmountPaidByCard" name="AmountPaidByCard" placeholder="Enter Amount Paid By Card" />
												</div>
											</div>
												
											<div class="form-row align-items-center mb-3">
												<div class="col-md-3">
													<label for="transaction_id" class="form-label">Transaction id
												</div>
												<div class="col-md-9">
													<input type="text" class="form-control" id="transaction_id" name="transaction_id" placeholder="Enter Amount Paid By Card" />
												</div>
											</div>
											
												<div class="form-row align-items-center mb-3">
												<div class="col-md-3">
													<label for="AmountPaidByGold" class="form-label">Amount Paid By Gold
												</div>
												<div class="col-md-9">
													<input type="text" class="form-control" id="AmountPaidByGold" name="AmountPaidByGold" placeholder="Enter Amount Paid By Gold" />
												</div>
											</div>
